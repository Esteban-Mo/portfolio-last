  ...
  return (
    <div className={styles.container}>
      ...
      <section className={styles.section}>
        ...
        <p>
          Dans le développement web, le choix du langage de programmation est essentiel, car il conditionne à la fois la manière de réfléchir, la structure du code, et les possibilités techniques offertes pour chaque projet.
        </p>
        <p>
          Mon usage principal se concentre aujourd'hui sur TypeScript et Python. TypeScript est un sur-ensemble de JavaScript qui ajoute un système de typage statique. En d'autres termes, là où JavaScript laisse une grande liberté (et donc parfois des erreurs difficiles à détecter), TypeScript impose une vérification des types à l'écriture du code. Cela permet d'éviter des bugs, d'avoir une meilleure lisibilité et de rendre le projet bien plus maintenable à long terme.
        </p>
        <p>
      ...
      <section className={styles.section}>
        ...
        <p>
          Concernant Python, j'ai eu l'occasion de beaucoup l'utiliser dans les projets Atlas et BDD Turbine. Ces deux projets ont nécessité un traitement de données pré-existantes, souvent stockées dans des fichiers Excel ou en base de données. J'ai donc utilisé Python pour écrire des scripts d'analyse, de nettoyage, et de conversion de ces données en formats exploitables, notamment pour une importation dans des bases PostgreSQL.
        </p>
        <p>
      ...
      <section className={styles.section}>
        ...
        <p>
          Aujourd'hui, je dirais que j'ai un niveau avancé en TypeScript, notamment grâce à mon usage quotidien en alternance et sur mes projets personnels. J'écris toujours du code typé strictement, ce qui me permet de garder un projet lisible, robuste, et facilement maintenable. Je maîtrise bien l'ensemble du cycle de développement fullstack avec TypeScript dans un environnement Next.js.
        </p>
        <p>
        ...
        <p>
          Je n'ai pas rencontré de blocage majeur avec l'un ou l'autre de ces langages, mais je sais que je pourrais encore progresser sur le typage avancé en TypeScript, notamment les types génériques, qui permettent d'écrire du code plus réutilisable et encore mieux encastré.
        </p>
      </section>
      ...
      <section className={styles.section}>
        ...
        <p>
          La maîtrise de TypeScript est aujourd'hui une compétence clé dans l'écosystème web moderne. Elle fait partie intégrante de mon projet professionnel, car la plupart des projets récents — qu'ils soient persos ou pros — sont pensés avec cette stack.
        </p>
        <p>
