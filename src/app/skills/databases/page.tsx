  ...
  return (
    <div className={styles.container}>
      ...
      <section className={styles.section}>
        ...
        <p>
          La base de données, c'est le cœur d'un projet, le socle sur lequel repose toute la logique métier, la persistance des informations et l'interconnexion entre les modules. En tant que développeur fullstack, la gestion de la base de données fait partie intégrante de mon quotidien, autant côté conception que manipulation.
        </p>
        <p>
      ...
      <section className={styles.section}>
        ...
        <p>
          Dans BDD Turbine, la base PostgreSQL était le cœur du projet. Toute la logique de l'application reposait sur la structure des données, leur cohérence, leur intégrité et leur accès rapide. J'ai conçu la structure, défini les relations, les types, géré les migrations et travaillé à l'optimisation.
        </p>
        <p>
      ...
      <section className={styles.section}>
        ...
        <p>
          Je me considère comme avancé sur PostgreSQL, avec une vraie aisance sur la modélisation, l'usage quotidien, et l'interfaçage via des ORM comme Prisma. J'utilise PgAdmin pour l'administration, mais je suis aussi à l'aise avec les requêtes en SQL brut quand j'ai besoin de précision ou de liberté.
        </p>
        <p>
      ...
      <section className={styles.section}>
        ...
        <p>
          La base de données est pour moi l'un des piliers du développement web, et encore plus pour un futur Tech Lead. Savoir concevoir, sécuriser, maintenir et faire évoluer une base est un prérequis absolu.
        </p>
        <p>
