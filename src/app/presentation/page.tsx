  ...
  return (
    <div className={styles.container}>
      ...
      <section className={styles.section}>
        ...
        <p>
          Curiosité, esprit d'équipe, rigueur et engagement guident mon travail, avec une volonté constante de livrer quelque chose de qualité. Pendant mes études, j'ai souvent pris des rôles de coordination, comme sur un projet collectif où j'ai réparti les tâches selon les forces de chacun pour avancer efficacement. Cela m'a appris à guider tout en restant ouvert aux idées des autres, et j'ai vu à quel point une équipe soudée produit des résultats concrets, même face à des obstacles qu'on a surmontés en testant des solutions.
        </p>
        <p>
